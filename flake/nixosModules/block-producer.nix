{self, ...}: {
  flake.nixosModules.block-producer = {
    ...
    signingKey = "${self}/secrets/${groupName}/${name}-byron-delegate.key";
    delegationCertificate = "${self}/secrets/${groupName}/${name}-byron-delegation-cert.json";
    ...
    vrfKey = "${self}/secrets/${groupName}/${name}-node-vrf.skey";
    kesKey = "${self}/secrets/${groupName}/${name}-node-kes.skey";
    operationalCertificate = "${self}/secrets/${groupName}/${name}-node.opcert";
    bulkCredentials = "${self}/secrets/${groupName}/${name}-bulk.creds";
