{
  ...
  inputs = {
    ...
    # Extra pins
    cardano-node-leios.url = "github:input-output-hk/ouroboros-leios?ref=refs/tags/prototype-2026w28";
    ...
    cardano-db-sync-leios.url = "github:IntersectMBO/cardano-db-sync/leios-prototype-2026w27";
